...
// customStatPointBuyConfig is no longer needed here as custom character is removed
...
interface CoreStatsSectionProps {
  ...
  // Props for custom stat point buy removed
...
export function CoreStatsSection({
  ...
  // Removed props: handleBuyStatPoint, handleSellStatPoint
  ...
  // CustomStatPointBuyComponent removed
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Always render StatInputComponent as custom character logic is removed */}
